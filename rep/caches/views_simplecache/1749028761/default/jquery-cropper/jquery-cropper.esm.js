 ...
 */
import $ from 'jquery';import Cropper from 'cropperjs';if($&&$.fn&&Cropper){var AnotherCropper=$.fn.cropper;var NAMESPACE='cropper';$.fn.cropper=function jQueryCropper(option){for(var _len=arguments.length,args=new Array(_len>1?_len-1:0),_key=1;_key<_len;_key++){args[_key-1]=arguments[_key]}
...
if(typeof option==='string'){var fn=cropper[option];if(typeof fn==='function'){result=fn.apply(cropper,args);if(result===cropper){result=undefined}
